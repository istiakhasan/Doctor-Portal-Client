            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-md-7 col-sm-12 text-white">
                        ...
                        <button style={{background:"#17D1BF",fontWeight:"bold",color:"white",padding:"10px",minWidth:"35%",border:"none",outline:"none",borderRadius:"5px"}} className=' mt-5'>Learn More</button>
                    </div>
                </div>
            </div>
